...
public class JWTAuthenticationFilter extends BasicAuthenticationFilter   {
    ...
    public JWTAuthenticationFilter(AuthenticationManager authenticationManager, AtomscatTokenProperties tokenProperties, StringRedisTemplate redisTemplate, SecurityUtil securityUtil) {
    ...
    private UsernamePasswordAuthenticationToken getAuthentication(String header, HttpServletResponse response) {
        ...
        if(StrUtil.isNotBlank(username)) {
            //Howell.Yang踩坑提醒 此处password不能为null
