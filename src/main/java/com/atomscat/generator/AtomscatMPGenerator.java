package com.atomscat.generator;

import com.atomscat.generator.bean.Entity;
 ...
 */
@Slf4j
public class AtomscatMPGenerator {

    /**
     * 实体类名
     * 建议仅需修改
     */
    private static final String className = "t_account_channel_mapping";
     ...
     * 建议仅需修改
     */
    private static final String author = "Howell.Yang";
     ...
     * (文件自动生成至该包下)
     */
    private static final String entityPackage = "com.atomscat.modules.og.entity";

    /**
     * dao对应包
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "com.atomscat.modules.og.dao.mapper";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "com.atomscat.modules.og.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String serviceImplPackage = "com.atomscat.modules.og.serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String controllerPackage = "com.atomscat.modules.og.controller";
    ...
    public static void main(String[] args) throws IOException {
        ...
        //模板路径
        String root = System.getProperty("user.dir")+"/src/main/java/com/atomscat/generator/template";
    ...
    private static void generateCode(GroupTemplate gt) throws IOException{
        ...
        entity.setTableName(tablePre+ AtomscatGenerator.camel2Underline(className));
        entity.setClassNameLowerCase(AtomscatGenerator.first2LowerCase(className));
        ...
        //创建文件
        String entityFileUrl = System.getProperty("user.dir")+"/src/main/java/"+ AtomscatGenerator.dotToLine(entityPackage) + "/" + className + ".java";
        ...
        log.info(daoResult);
        //创建文件
        String daoFileUrl = System.getProperty("user.dir")+"/src/main/java/"+ AtomscatGenerator.dotToLine(daoPackage) + "/" +className + "Mapper.java";
        ...
        //创建文件
        String serviceFileUrl = System.getProperty("user.dir")+"/src/main/java/"+ AtomscatGenerator.dotToLine(servicePackage) + "/I" + className + "Service.java";
        ...
        //创建文件
        String serviceImplFileUrl = System.getProperty("user.dir")+"/src/main/java/"+ AtomscatGenerator.dotToLine(serviceImplPackage) + "/I" + className + "ServiceImpl.java";
        ...
        //创建文件
        String controllerFileUrl = System.getProperty("user.dir")+"/src/main/java/"+ AtomscatGenerator.dotToLine(controllerPackage) + "/" + className + "Controller.java";
